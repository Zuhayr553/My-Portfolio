            ...
            child: Column(
              ...
              children: [
                ...
                if (!Responsive.isMobileLarge(context))
                  ElevatedButton(
                    onPressed: () {
                      launchMyURL("https://wa.me/923339156667");
                    },
    ...
    return DefaultTextStyle(
      ...
      child: Row(
        children: [
          ...
          Text(""),
          Responsive.isMobile(context) ? Text("") : AnimatedText(),
          if (!Responsive.isMobileLarge(context))
            SizedBox(width: defaultPadding / 2),
          if (!Responsive.isMobileLarge(context)) FlutterCodedText(),
        ],
...
class AnimatedText extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AnimatedTextKit(
      animatedTexts: [
        TyperAnimatedText(
          "Flutter Developer With Over Two Years Of Experience",
          speed: Duration(milliseconds: 60),
        ),
        TyperAnimatedText(
          "Over 10 Live Apps On Google and Apple Store",
          speed: Duration(milliseconds: 60),
        ),
        TyperAnimatedText(
